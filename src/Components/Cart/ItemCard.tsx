...
export const Items = () => (
    <div className='flex items-center'>
        ...
        <div>
            <div className='flex items-center'>
                <h3 className="font-outfit">Balmain</h3>
                <button>
            ...
            <p className="font-outfit">Double - breasted denim jacket</p>
            <div className='flex items-center justify-between'>
                <p className="font-outfit">Size 36 FR</p>
                <button>Edit</button>
            </div>
            <div className='flex items-center justify-between'>
                <p className="text-base font-medium font-outfit">₦717,575</p>
                <div className="flex items-center border-borderCartActions border-[1px] w-fit px-1 gap-2">
                    <button>
