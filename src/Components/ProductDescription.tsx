...
export const ProductDetailsDescription = () => {
    ...
    return (
        <section className="bg-[#f6f6f6] font-outfit p-4 md:p-6">
            <h2 className="text-[1.2rem] font-bold">MARNI</h2>
            <p className="text-[1.1rem] my-2">Light crossbody bag with shoelace strap</p>
            <p className="text-[1.1rem] font-medium">₦717,575</p>
            ...
            <div className="flex gap-2 items-center">
                <CartBtn text="Add to Cart" width="w-full" />
            ...
            <button className="flex items-center text-Black text-sm my-4">
                Find out more
