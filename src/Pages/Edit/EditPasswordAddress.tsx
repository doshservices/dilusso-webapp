...
export default function EditPasswordAddress() {
  return (
    <div className=" mt-[5rem] sm:mt-[7rem] flex gap-10 relative lg:mt-[9rem] px-[5%]">
      <div className=" w-[20%] text-center sticky top-0 pb-6 ">
      ...
      {/* contents */}
      <section className="w-[55%]  text-[#344054] font-medium text-[0.9rem] ">
        <div>
          <h2 className=" bg-black text-center text-[1.3rem] text-white px-5 py-2 mx-auto ">
            Edit your delivery address
          </h2>

          <form action="" className="py-[5%] flex flex-col gap-5 ">
            <section className="flex justify-between ">
              <div className="w-[48%] flex flex-col gap-1 ">
                <label htmlFor="firstName">first name</label>
                <input
                  type="text"
                  className=" outline-none text-center text-[1rem] px-[2%] py-[6px] border-black border-[1px] w-full "
                  name=""
                  id="firstName"
                  placeholder="Ezekiel"
                />
            ...
            <section className="w-[48%] flex flex-col gap-1 ">
